...
Em uma classe que precise gerar logs, receber um objeto do tipo Logger com o método abaixo: public void log(String message)
...
O diagrama que criei está neste link aqui. Mas te aconselho muito tentar bem antes de olhar qualquer imagem.